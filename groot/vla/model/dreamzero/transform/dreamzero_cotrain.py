        ...
        if key == "text":
            ...
            for elem in features:
                ...
                try:
                    ...
                    elif elem["embodiment_id"] == embodiment_tag_mapping[EmbodimentTag.DRONE.value]:
                        processed_item = "A single view video shows that a drone " + processed_item.lower()
                    else:
                    ...
                    if num_views > 1 and elem["embodiment_id"] == embodiment_tag_mapping[EmbodimentTag.AGIBOT.value]:
                        ...
                        item = "A single view video shows that a drone " + str(item).lower()
                    else:
                        raise ValueError(f"Embodiment ID {elem['embodiment_id']} not supported.")   
